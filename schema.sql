...
\restrict FTV7aMNvofysEH6UhDDLeCgQAtlOd52Sp91nrF85iPyZgSHZFoIt2Yg8VEwpZ3j
...
ALTER FUNCTION public.cleanup_expired_otp_codes() OWNER TO depravationdo;
...
ALTER FUNCTION public.cleanup_expired_registration_tokens() OWNER TO depravationdo;
...
ALTER FUNCTION public.cleanup_expired_reset_tokens() OWNER TO depravationdo;
...
ALTER FUNCTION public.cleanup_expired_verification_tokens() OWNER TO depravationdo;
...
ALTER FUNCTION public.update_updated_at_column() OWNER TO depravationdo;
...
ALTER TABLE public.account_deletion_logs OWNER TO depravationdo;
...
ALTER TABLE public.notebook_entries OWNER TO depravationdo;
...
ALTER TABLE public.notebooks OWNER TO depravationdo;
...
ALTER TABLE public.oauth_accounts OWNER TO depravationdo;
...
ALTER TABLE public.oauth_providers OWNER TO depravationdo;
...
ALTER TABLE public.otp_codes OWNER TO depravationdo;
...
ALTER TABLE public.otp_codes_id_seq OWNER TO depravationdo;
...
ALTER TABLE public.password_reset_tokens OWNER TO depravationdo;
...
ALTER TABLE public.quiz_results OWNER TO depravationdo;
...
ALTER TABLE public.registration_email_tokens OWNER TO depravationdo;
...
ALTER TABLE public.users OWNER TO depravationdo;
...
ALTER TABLE public.word_definitions OWNER TO depravationdo;
...
ALTER TABLE public.words OWNER TO depravationdo;
...
\unrestrict FTV7aMNvofysEH6UhDDLeCgQAtlOd52Sp91nrF85iPyZgSHZFoIt2Yg8VEwpZ3j
